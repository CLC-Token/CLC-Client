...
/**
 * Description: https://github.com/laobie/StatusBarUtil 抽取过来   <br>
 * Author: cxh <br>
...
public class StatusBarUtil {
     ...
     */
    private static void processMIUI(Activity activity, boolean dark) {
        ...
        if (window != null) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && RomUtils.isMiUIV7OrAbove()) {
                    ...
                    activity.getWindow().getDecorView().findViewById(android.R.id.content).setPadding(0, getStatusBarHeight(activity), 0, 0);
                }
            } catch (Exception e) {
    ...
    public static void setStatusTextColor(boolean useDart, Activity activity) {
        setStatusTextColor(useDart , activity , false);
    }
     ...
     * @param useDart 是否使用深色调
     */
    public static void setStatusTextColor(boolean useDart, Activity activity, boolean statusIsImg) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            switch (RomUtils.getLightStatusBarAvailableRomType()) {
                ...
                case RomUtils.AvailableRomType.ANDROID_NATIVE:
                    setAndroidNativeLightStatusBar(activity, useDart);
                    if (!statusIsImg) {
                        activity.getWindow().getDecorView().findViewById(android.R.id.content).setPadding(0, getStatusBarHeight(activity), 0, 0);
                    }
                    break;
    ...
    public static void newSetStatusColor(Activity activity){
    ...
    public static void setTopHeader(View view){
        if(null != view) {
            view.setPadding(0, StatusBarUtil.getStatusBarHeight(WorkApp.workApp), 0, 0);
        }
    }
}